...
this.clubId=clubId;
    ...
    public demandeadhesion(String dureInsc, String modePayment, int numParent, String ancienClub, String objectif, String nomclub) {
        this.dureInsc = dureInsc;
        this.modePayment = modePayment;
        this.numParent = numParent;
        this.ancienClub = ancienClub;
    ...
    public demandeadhesion(String dureInsc, String modePayment, String ancienClub, String objectif) {
        this.dureInsc = dureInsc;
        this.modePayment = modePayment;
        this.ancienClub = ancienClub;
        this.objectif = objectif;
    ...
    public String toString() {
        return "demandeadhesion{" + "id=" + id + ", dureInsc=" + dureInsc + ", modePayment=" + modePayment + ", numParent=" + numParent + ", ancienClub=" + ancienClub + ", objectif=" + objectif + ", clubId=" + clubId + ", etatDemande=" + etatDemande + '}';
    }
